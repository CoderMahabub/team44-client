	...
	return (
		<div className="sidebar">
			<div className="sidebarItem">
				...
				/>
				<p>
					CrazyBlog is a blog website for daily users who love to read different types of blog posts in a same
					platform with best quality blogs from a huge number of authors and writers.
				</p>
			</div>
			<div className="sidebarItem">
